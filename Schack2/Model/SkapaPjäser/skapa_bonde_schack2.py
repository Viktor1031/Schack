...
def lägg_till_beetenden_för_bonde_schack2(pjäs, vit,alla_drag_gjorda_lista):
    if vit==True:
        ...
        pjäs.lägg_till_flytt_beteende(FlyttGraf(0, -1, 1),False)
def skapa_pjäs_bonde_schack2(schack_bräde,x,y,vit,alla_drag_gjorda_lista):
    if vit==True:
        bonde=Pjäs("Vit Bonde","B", "wP", schack_bräde, x, y, 0,1) #♙
        lägg_till_beetenden_för_bonde_schack2(bonde,vit,alla_drag_gjorda_lista)
    else:
