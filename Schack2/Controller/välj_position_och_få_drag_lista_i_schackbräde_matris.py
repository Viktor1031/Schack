from .matris_funktioner import välj_vektor2_position_i_matris, sträng_till_vektor2_position_i_matris
...
def få_drag_lista_från_vald_sträng_position_i_schackbräde_matris(schackbräde_matris, nuvarande_spelare_färg, vald_sträng):
    vald_vektor = sträng_till_vektor2_position_i_matris(schackbräde_matris, vald_sträng)
    return få_drag_lista_från_vektor2_i_schackbräde_matris(schackbräde_matris, nuvarande_spelare_färg,vald_vektor)

def få_drag_lista_från_vektor2_i_schackbräde_matris(schackbräde_matris, nuvarande_spelare_färg, vald_vektor):
    if vald_vektor != None:
        vald_position = schackbräde_matris[vald_vektor[0]][vald_vektor[1]]
        if vald_position.pjäs != None:
            if vald_position.pjäs.färg != nuvarande_spelare_färg:
