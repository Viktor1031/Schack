...
def välj_vektor2_position_i_matris(matris): #Används inte längre tack vare ny input
...
def sträng_till_vektor2_position_i_matris(matris,sträng):

        vald_sträng_position=sträng
