...
from Model.skapa_schack_bräde_funktioner import skapa_standard_schackbräde_matris_schack2
...
standard_schackbräde_matris=skapa_standard_schackbräde_matris_schack2(spel_tillstånd)
spela_schack_match(standard_schackbräde_matris,spel_tillstånd)
#Spelet krachar när det blir schackmatt. Kollar efter bästa drag när det inte finns något giltigt drag
#Bönder kan gå egenom pjäser när dem går 2 drag